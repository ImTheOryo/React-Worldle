...
export function ModalPlayOtherDay() {
    return (
        <div className="fixed top-16 right-6 z-50 bg-slate-50 rounded-xl p-6 border border-slate-200 shadow-lg flex flex-col items-center gap-4 w-80 transition-all hover:shadow-xl">
